...
\begin{proof}
    Two atoms are different when either their variables or names are different. Consider two atoms $p\left(x_1, \dots, x_{|p|}\right)$ and $q\left(y_1, \dots, y_{|q|}\right)$ that 
	\begin{itemize}
