...
\begin{figure}
    \centering
    \input{\master/Graphics/ek-move-v.pgf}
...
\begin{figure}
    \centering
    \input{\master/Graphics/ek-push-h.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/ek-push-v.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/ek-push-h-goal.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/ek-push-v-goal.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/pk-move-v.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/pk-push-h.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/pk-push-v.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/pk-push-h-goal.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
...
\begin{figure}
    \centering
    \input{\master/Graphics/pk-push-v-goal.pgf}
        \label{fig:ex:ca:hgma:ex:move-h}
