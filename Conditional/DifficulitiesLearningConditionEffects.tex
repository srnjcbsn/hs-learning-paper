...
From the discussion above, it is evident that the model used for preconditions of non-conditional actions are not sufficient for 

\begin{definition}[Connection]\label{def:ca:connection}
    A connection is a sequence of pairs $\left( p, i \right)$
\end{definition}
