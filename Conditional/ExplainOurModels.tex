...
\begin{figure}
    ...
    \begin{subfigure}{0.28\textwidth}
        \centering
        \resizebox{0.65\linewidth}{!}{\raisebox{-0.5\height}{\input{\master/Graphics/graph.pgf}}}
        \caption{$H_2$}
        \label{fig:ca:graphExGraph}
    \end{subfigure}
    \begin{subfigure}{0.28\textwidth}
        \centering
        \resizebox{0.65\linewidth}{!}{\raisebox{-0.5\height}{\input{\master/Graphics/graphExample.pgf}}}
        \caption{$H_2$}
