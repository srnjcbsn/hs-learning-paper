...
A thorough explanation of learning conditional effects using hypergraphs is given in Appendix~\ref{sec:app:hypergraph}, and we will summarize the most important findings here. We have explored two different approaches to using hypergraphs, which both come with their own trade-offs.
