...
The ways an agent can change the state, and under which circumstances, is decribed by \textit{action schemas}. 
...
\begin{definition} \label{def:lrn:action-spec-def}
    ...
    Goal Description or GD is specifically designed logic formula for describing preconditon. Effect or EFF is another logical construct for describing effects of an action.
